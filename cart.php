...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Shopping Cart || CC Sports Shop</title>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer style="margin-top:10px;">
           <p style="text-align:center; font-size:0.8em;clear:both;">&copy; CC Sports Shop. All Rights Reserved By Pranav Yadav, Tsering Paljor And Shahrukh Zarir.</p>
        </footer>
