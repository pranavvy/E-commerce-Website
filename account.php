...
<html class="no-js" lang="en">
  <head>
    ...
    <title>My Account || CC Sports Shop</title>
  ...
  <body>
    ...
    <div class="row" style="margin-top:30px;">
      <div class="small-12">
        ...
        <p>Below are the current details we have on your account. To update information, enter the new data in the text fields and click update. .</p>
      </div>
    </div>
