...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Register || CC Sports Shop</title>
      ...
      <div class="row">
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="29 John Smith Ave" name="address">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Oshawa" name="city">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="number" id="right-label" placeholder="L5W1B4" name="pin">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="ccsports@shop.com" name="email">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
